            ...
            "
                    >
                        ...
                        <form @submit.prevent="authStore.handleRegister(form)">
                            <div v-if="authStore.authStatus" class="success-message">
                                <p class="text-green-400 text-sm m-2 p-2">{{ authStore.authStatus }}</p>
                            </div>
                            <div class="mb-6">
                                <input
                                    type="text"
                  ...
                  "
                                />
                                <div v-if="authStore.errors.confirmPassword" class="flex">
                                    <span class="text-red-400 text-sm m-2 p-2">{{
                                            authStore.errors.confirmPassword
                                        }}</span>
                                </div>
                            </div>
                            <div class="mb-10">
